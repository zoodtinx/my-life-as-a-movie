   ...
   return (
      ...
      >
         <SliderPrimitive.Track
            ...
            className={cn(
               "bg-secondary/10 relative grow overflow-hidden rounded-full",
         ...
         {Array.from({ length: _values.length }, (_, index) => (
            <SliderPrimitive.Thumb
               ...
               key={index}
               className={cn(
                  "border-secondary bg-background ring-secondary block size-4 shrink-0 rounded-full border shadow-sm transition-[color,box-shadow]",
